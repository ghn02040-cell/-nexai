    ...
    <div>
      ...
      <section className="hero-gradient relative overflow-hidden text-white">
        <div className="container-x grid items-center gap-10 py-20 md:py-28 lg:grid-cols-2">
          <div className="animate-fadeUp">
            <p className="eyebrow !bg-white/15 !text-sky">ONLINE AI EDUCATION</p>
            ...
            <div className="mt-10 flex gap-8 text-sm">
              <div>
                <div className="text-3xl font-extrabold text-amber">5+</div>
              ...
              <div>
                <div className="text-3xl font-extrabold text-amber">24/7</div>
      ...
      <section className="container-x pb-20">
        <div className="hero-gradient flex flex-col items-center gap-5 rounded-3xl px-6 py-14 text-center text-white">
          <h2 className="text-2xl font-extrabold md:text-3xl">지금, AI 학습을 시작하세요</h2>
          <p className="max-w-xl text-navy-100">
            모바일에서도 끊김 없이. 라이트·다크 모드로 편안하게. 에이아이카데미와 함께라면 누구나 AI 전문가에 한 걸음 가까워집니다.
          </p>
